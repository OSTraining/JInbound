...
CREATE TABLE IF NOT EXISTS `#__jinbound_campaigns` (
  ...
  `label` TINYINT(1) NULL DEFAULT '0' COMMENT 'label type',
  `greedy` TINYINT(1) NULL DEFAULT '0' COMMENT 'this campaign wants the contacts to itself',
  `conversion_url` TEXT NOT NULL COMMENT 'query params that denote a successful conversion',
  `published` TINYINT(1) NULL DEFAULT '0' COMMENT 'publication status of record - 0 is Unpublished, 1 is Published, -2 is Trashed',
  ...
  `checked_out` INT(11) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'Locking column to prevent simultaneous updates',
  `checked_out_time` DATETIME NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT 'Date and Time record was checked out',
  `params` TEXT NULL DEFAULT NULL COMMENT 'JSON encoded custom parameters',
  PRIMARY KEY (`id`))
ENGINE = InnoDB
...
CREATE TABLE IF NOT EXISTS `#__jinbound_contacts` (
  ...
  `cookie` VARCHAR(255) NULL DEFAULT NULL COMMENT 'Cookie value',
  `alias` VARCHAR(255) NOT NULL COMMENT 'Slug for URL',
  `first_name` VARCHAR(255) NOT NULL COMMENT 'First name of Contact',
  `last_name` VARCHAR(255) NOT NULL COMMENT 'Last name of Contact',
  ...
  `email` VARCHAR(255) NOT NULL COMMENT 'Email of Contact',
...
CREATE TABLE IF NOT EXISTS `#__jinbound_contacts_campaigns` (
  ...
  `added` DATETIME NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT 'when contact was added to campaign, in UTC')
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;


-- -----------------------------------------------------
-- Table `#__jinbound_contacts_followers`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `#__jinbound_contacts_followers` (
  `contact_id` INT(11) NOT NULL COMMENT 'Primary key of contact',
  `follower_id` INT(11) NOT NULL COMMENT 'Primary key of user',
  UNIQUE INDEX `idx_contact_follower` (`contact_id` ASC, `follower_id` ASC))
ENGINE = MyISAM
DEFAULT CHARACTER SET = utf8;
...
CREATE TABLE IF NOT EXISTS `#__jinbound_conversions` (
  ...
  `checked_out` INT(11) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'Locking column to prevent simultaneous updates',
  `checked_out_time` DATETIME NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT 'Date and Time record was checked out',
  `formdata` TEXT NULL DEFAULT NULL COMMENT 'JSON encoded form data',
  PRIMARY KEY (`id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
CREATE TABLE IF NOT EXISTS `#__jinbound_emails_records` (
  ...
  `sent` DATETIME NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT 'when record was created, in UTC',
  PRIMARY KEY (`id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
CREATE TABLE IF NOT EXISTS `#__jinbound_emails_versions` (
  ...
  `htmlbody` BLOB NULL DEFAULT NULL,
  `plainbody` BLOB NULL DEFAULT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
CREATE TABLE IF NOT EXISTS `#__jinbound_fields` (
  ...
  `description` TEXT NOT NULL COMMENT 'Description of field displayed to the end user',
  `default` VARCHAR(255) NOT NULL DEFAULT '' COMMENT 'Default value of the field',
  `params` TEXT NOT NULL COMMENT 'Various parameters for field - options, html attributes, etc',
  `created` DATETIME NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT 'when field was created',
  `created_by` INT(11) NOT NULL DEFAULT '0' COMMENT 'User id of field creator',
  `modified` DATETIME NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT 'when field was last modified',
  `modified_by` INT(11) NOT NULL DEFAULT '0' COMMENT 'User id of last modifier',
  `published` TINYINT(1) NULL DEFAULT '0' COMMENT 'Publication status',
  `checked_out` INT(11) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'Locking column to prevent simultaneous updates',
  `checked_out_time` DATETIME NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT 'when field was checked out',
  PRIMARY KEY (`id`))
ENGINE = MyISAM
DEFAULT CHARACTER SET = utf8;
...
CREATE TABLE IF NOT EXISTS `#__jinbound_forms` (
  ...
  `created` DATETIME NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT 'when form was created',
  `created_by` INT(11) NOT NULL DEFAULT '0' COMMENT 'User id of form creator',
  `modified` DATETIME NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT 'when form was last modified',
  `modified_by` INT(11) NOT NULL DEFAULT '0' COMMENT 'User id of last modifier',
  `published` TINYINT(1) NULL DEFAULT '0' COMMENT 'Publication status',
  `checked_out` INT(11) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'Locking column to prevent simultaneous updates',
  `checked_out_time` DATETIME NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT 'Date and Time form was checked out',
...
CREATE TABLE IF NOT EXISTS `#__jinbound_lead_statuses` (
  ...
  `default` TINYINT(1) NULL DEFAULT '0' COMMENT 'Default status',
  `active` TINYINT(1) NULL DEFAULT '0' COMMENT 'Active statuses count towards leads, inactive do not',
  `final` TINYINT(1) NULL DEFAULT '0' COMMENT 'Final status',
  `published` TINYINT(1) NULL DEFAULT '0' COMMENT 'publication status of record - 0 is Unpublished, 1 is Published, -2 is Trashed',
  `created` DATETIME NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT 'when record was created, in UTC',
  `created_by` INT(11) NOT NULL DEFAULT '0' COMMENT 'User id of record creator',
  `modified` DATETIME NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT 'when record was last modified in UTC',
...
-- -----------------------------------------------------
-- Table `#__jinbound_leads`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `#__jinbound_leads` (
  `id` INT(11) NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `asset_id` INT(11) NOT NULL COMMENT 'Key for assets table',
  `page_id` INT(11) NOT NULL COMMENT 'Primary key of Page associated with this lead',
  `contact_id` INT(11) NOT NULL COMMENT 'Primary key of Contact associated with this lead',
  `priority_id` INT(11) NOT NULL COMMENT 'Primary key of Priority associated with this lead',
  `status_id` INT(11) NOT NULL COMMENT 'Primary key of Status associated with this lead',
  `campaign_id` INT(11) NOT NULL COMMENT 'Primary key of Campaign associated with this lead',
  `first_name` VARCHAR(255) NOT NULL COMMENT 'First name of Lead (contacts uses single column for both names)',
  `last_name` VARCHAR(255) NOT NULL COMMENT 'Last name of Lead (contacts uses single column for both names)',
  `ip` VARCHAR(255) NOT NULL DEFAULT '' COMMENT 'IPv4/6 address of record creator',
  `published` TINYINT(1) NULL DEFAULT '0' COMMENT 'publication status of record - 0 is Unpublished, 1 is Published, -2 is Trashed',
  `created` DATETIME NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT 'when record was created, in UTC',
  `created_by` INT(11) NOT NULL DEFAULT '0' COMMENT 'User id of record creator',
  `modified` DATETIME NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT 'when record was last modified in UTC',
...
CREATE TABLE IF NOT EXISTS `#__jinbound_notes` (
  ...
  `published` TINYINT(1) NULL DEFAULT '1' COMMENT 'publication status of record - 0 is Unpublished, 1 is Published, -2 is Trashed',
  `created` DATETIME NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT 'when record was created, in UTC',
  `created_by` INT(11) NOT NULL DEFAULT '0' COMMENT 'User id of record creator',
  `modified` DATETIME NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT 'when record was last modified in UTC',
  `modified_by` INT(11) NOT NULL DEFAULT '0' COMMENT 'User id of last modifier',
...
CREATE TABLE IF NOT EXISTS `#__jinbound_pages` (
  ...
  `hits` INT(11) NULL DEFAULT '0' COMMENT 'number of views for this record',
  `published` TINYINT(1) NULL DEFAULT '0' COMMENT 'publication status of record - 0 is Unpublished, 1 is Published, -2 is Trashed',
  `created` DATETIME NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT 'when record was created, in UTC',
  `created_by` INT(11) NOT NULL DEFAULT '0' COMMENT 'User id of record creator',
  `modified` DATETIME NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT 'when record was last modified in UTC',
...
CREATE TABLE IF NOT EXISTS `#__jinbound_stages` (
  ...
  `name` VARCHAR(255) NOT NULL COMMENT 'name of this record',
  `description` MEDIUMTEXT NOT NULL COMMENT 'description of this record',
  `ordering` INT(11) NOT NULL DEFAULT '0' COMMENT 'Ordering column for stage level',
  `published` TINYINT(1) NULL DEFAULT '0' COMMENT 'publication status of record - 0 is Unpublished, 1 is Published, -2 is Trashed',
  `created` DATETIME NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT 'when record was created, in UTC',
  `created_by` INT(11) NOT NULL DEFAULT '0' COMMENT 'User id of record creator',
  `modified` DATETIME NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT 'when record was last modified in UTC',
...
CREATE TABLE IF NOT EXISTS `#__jinbound_tracks` (
  ...
  `cookie` VARCHAR(255) NULL DEFAULT NULL COMMENT 'Cookie value for this track',
  ...
  `user_agent` TEXT NULL DEFAULT NULL COMMENT 'Browser User Agent',
  `created` DATETIME NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT 'Date this request was made',
  `ip` VARCHAR(64) NULL DEFAULT NULL COMMENT 'IP address as determined by PHP, either ipv4 or ipv6',
  `session_id` VARCHAR(255) NULL DEFAULT NULL COMMENT 'Session ID as determined by PHP',
  `type` ENUM('GET', 'POST', 'HEAD', 'PUT') NULL DEFAULT NULL COMMENT 'Request type',
  `url` TEXT NULL DEFAULT NULL COMMENT 'URL of the request',
  PRIMARY KEY (`id`))
ENGINE = MyISAM
DEFAULT CHARACTER SET = utf8;
