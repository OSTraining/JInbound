...
class com_JInboundInstallerScript extends AbstractScript
{
    ...
    {
        // @TODO: Fix issues with recent updates
        if ($type == 'update'
            && version_compare($this->previousManifest->version, '3', 'lt')
        ) {
            JFactory::getApplication()->enqueueMessage(
                'Due to issues with upgrading, we are temporarily preventing updates from < v3.0.0',
                'notice'
            );
        ...
        return parent::preFlight($type, $parent); // TODO: Change the autogenerated stub
    }
    ...
    public function postflight($type, $parent)
    {
        try {
            ...
            switch ($type) {
                ...
                case 'update':
                    // @TODO: Temporarily disabling due to upgrade issues
                    //$this->removePackage();
                    //$this->checkAssets();
